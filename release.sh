...
if test $# -lt 1; then
  ...
  mv openwrt-ipq40xx-linksys_ea6350v3-squashfs-sysupgrade.binapp/src/main/assets/ea6350.bin
  mv openwrt-ipq40xx-glinet_gl-b1300-squashfs-sysupgrade.binapp/src/main/assets/glb1300.bin
  mv openwrt-ar71xx-generic-mynet-n750-squashfs-sysupgrade.binapp/src/main/assets/n750.bin
  mv openwrt-ar71xx-generic-mynet-n600-squashfs-sysupgrade.binapp/src/main/assets/n600.bin
  mv openwrt-mvebu-cortexa9-linksys-wrt3200acm-squashfs-sysupgrade.binapp/src/main/assets/wrt3200acm.bin
  mv openwrt-mvebu-cortexa9-linksys-wrt32x-squashfs-sysupgrade.binapp/src/main/assets/wrt32x.bin
  rm openwrt*
fi
